...
public class ChiDep {
	String id;
	String hoTen;
	TreeSet<QuaTrinhLamNghe> ngheNghiepList;
	LinkedList<Integer> diemQuaTrinh;
	boolean biLoai;
	String tenVongBiLoai;

	public ChiDep(String id, String hoTen) {
		this.id = id;
		this.hoTen = hoTen;
		this.ngheNghiepList = new TreeSet<QuaTrinhLamNghe>();
		this.diemQuaTrinh = new LinkedList<Integer>();
	}
	...
	public String toString() {
		return "ID=" + id + "\t Tên=" + hoTen + "\t Danh sách Nghề=" + ngheNghiepList + "\t Điểm quá trình="
				+ diemQuaTrinh + "\t Đã bị loại=" + biLoai + "\t Tên vòng bị loại=" + tenVongBiLoai + "]\n";
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(hoai.toString());
